...
- 2026-08-22 · Branch naming: use `<type>/<name>` (`feat/…`, `fix/…`, `docs/…`) branching off `origin/web`, PRs target `web`. NEVER name branches `web/*` — while `refs/heads/web` exists, git structurally rejects any `web/*` ref.
